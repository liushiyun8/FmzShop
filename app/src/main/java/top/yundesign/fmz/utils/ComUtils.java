...
public class ComUtils {
	...
	ConnectivityManager connectivity = (ConnectivityManager) App.app
	...
	ConnectivityManager cm = (ConnectivityManager) App.app
		.getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	LogUtils.e("Tips", tip);
	Toast.makeText(App.app, tip, Toast.LENGTH_SHORT).show();
    }

    public static void longTips(String tip) {
	Toast.makeText(App.app, tip, Toast.LENGTH_LONG).show();
    }

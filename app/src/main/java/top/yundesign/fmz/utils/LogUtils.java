...
public class LogUtils {
    ...
    public static final int LEVEL = AppConfig.isDebug ? VERBOSE : ERROR;
    public static final String SEPARATOR = ",";

    private static boolean LOG2FILE = !AppConfig.isDebug;
    ...
    public static ConcurrentHashMap<String, LogInfo> logHashMap = new ConcurrentHashMap<String, LogInfo>();
    ...
    public static void log2File(String tag, String message) {
        ...
        synchronized (logInfo) {
            ...
            if (logInfo.raf != null) {
                ...
                writeTxtToFile("[" + time + "]" + "[" + tag + "]" + message, logInfo.raf);
            }
        }

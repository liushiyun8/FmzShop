...
import top.yundesign.fmz.UI.fragment.VideoFragment;
...
public enum  HometypeEnum {
    HOME(0, "首页", HomeFragment.newInstance()),FIND(1,"发现", VideoFragment.newInstance()),FENLEI(2,"分类", CategoryFragment.newInstance()),
